...
public class JosephusPermutationTest {
    ...
    private void josephusTest(final Object[] items, final int k, final Object[] result) {
        assertThat(JosephusPermutation.JosephusPermutation.Josephus.josephusPermutation(new ArrayList(Arrays.asList(items)), k), CoreMatchers.<List>is(Arrays.asList(result)));
    }
